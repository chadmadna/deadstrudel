...
_$BASS: note(`<f#1*8!7 [a1 a1 c#2 f#2@2 c#2 f#2 c2]>`) // verse
...
await loadScript("http://localhost:3002/hydra-text.js");
...
solid(0)
  ...
  // .layer(text(str).modulateScale(noise(1, .3), .1))
  // .diff(strokeText(str).modulateScale(noise(10, 2), .01))
  .out(o0);
