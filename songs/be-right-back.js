...
_$PADS:
  ...
  // chord(`<Bm DM7 F#m A2>`).slow(2).anchor("B2").voicing().vel(.5) // ada yg ngomong dari surga
    // stack(
    //   chord(`<F C G Am F Em Am@2>`).anchor("F3").voicing().vel(.5),
    // // note(`c3@4 d3@3 c3@5 e3@3 d3@5 f3@3 e3@2 c3@5 c3 b3@5 a3@4 g3@5 c3@2 b3@6 c4 b3 a3@5 d3@3 c3`).slow(8),
    // )
...
solid(0)
  ...
  // .add(src(o1).mask(shape(100, 0.5, 0.9)).scale(1, height / width), 0.7)  // midi to hydra goodness..
  .out(o0)
